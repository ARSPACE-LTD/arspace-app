  ...
  void paymentBottomSheet(EventController eventController) {
    ...
    showModalBottomSheet(
      ...
      builder: (builder) {
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setState) {
            return eventController.isCardAdded == true
            //return eventController.cardList.isEmpty
             ?Container(
                             ...
                             return Column(
                               children: [
                                 GestureDetector(
                                   onTap:(){
                                     setState(() {
                                      eventController.selectedIndex = index;
                                     });
                                   },
                                   child: Padding(
                                     padding: EdgeInsets.symmetric(horizontal: 14),
                                     child: Container(
                                       ...
                                       height:screenHeight *.08,
                                         ...
                                         decoration: BoxDecoration(
                                           border: Border.all(
                                             color:eventController.selectedIndex==index? Colors.white : Colors.transparent, // Change border color based on selected state
                                             width:eventController.selectedIndex==index ? 2.0 : 0.0, // Change border width based on selected state
                                           ),
                                           color: ThemeProvider.text_background,
                                           borderRadius: BorderRadius.circular(14),
                                         ),
                                         ...
                                         // ListTile(
                                         //     title:CommonTextWidget(
                                         //       heading:   "${eventController.geteventInfo.data?.tickets![index].name}",
                                         //       //  heading: AppString.early_bird_ticket,
                                         //       fontSize: Dimens.eighteen,
                                         //       color: ThemeProvider.whiteColor,
                                         //       fontFamily: 'Lexend',
                                         ...
                                         //     ),
                                         //     trailing:CommonTextWidget(
                                         //       heading:   "${eventController.geteventInfo.data?.tickets![index].price}",
                                         //
                                         //       fontSize: Dimens.twenty,
                                         //       color: ThemeProvider.whiteColor,
                                         //       fontFamily: 'Lexend',
