...
import 'package:arspace/backend/helper/shimmer_arrows.dart';
import 'package:arspace/util/dimens.dart';
              ...
              child: Row(
                children: [
                  AnimatedContainer(
                    ...
                    height: widget.height,
                    width: _position + widget.height <= widget.width
                        ? _position + widget.height
                        : widget.width,
                    decoration: BoxDecoration(
          ...
          Positioned(
              ...
              child: Center(
                child: Text(widget.text,
                    style: TextStyle(
                        color: ThemeProvider.whiteColor, fontSize: 16,fontFamily: "Lexend",fontWeight: FontWeight.w700)),
              )),
          Positioned(
            top: 0,
            right: 0,
